 ...
 */
//Servlet 3.0提供的规范，初始化会寻找META-INF下service包下的javax.servlet.ServletContainerInitializer文件
//加载其中的类，也就是这个类，执行onStartup方法，@HandlesTypes会将工程里实现WebApplicationInitializer接口的所有
//接口，类	引入onStartup方法的webAppInitializerClasses参数中
...
public class SpringServletContainerInitializer implements ServletContainerInitializer {
	...
	public void onStartup(@Nullable Set<Class<?>> webAppInitializerClasses, ServletContext servletContext)
		...
		//这里执行onStartup方法会创建根容器，web容器，DispatcherServlet
